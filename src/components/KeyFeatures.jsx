    ...
    <section>
      <div className="max-w-7xl mx-auto px-4 mt-20">
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView="visible"
          className="flex flex-wrap justify-between p-6"
        >
          {KEY_FEATURES_CONTENT.features.map((feature) => (
            <motion.div
              key={feature.id}
              className="flex flex-col items-center text-center w-full md:w-1/2 lg:w-1/3 "
            ...
            >
              ...
              <p className=" mb-6 text-neutral-400"> {feature.description}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
