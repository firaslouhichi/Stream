        ...
        >
          {TESTIMONIALS_CONTENT.reviews.map((review, index) => (
            <motion.div
              ...
              className="mt-10 flex flex-col items-start justify-center overflow-hidden rounded-2xl bg-neutral-900/50 border border-neutral-900 p-10"
            >
              ...
              <p className="mt-2 text-neutral-200">{review.review}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
